...
## Project Structure
    ...
    ├── testapiautoteammemb_75319  # Django project configurations
...
1. Clone this repo and `cd testapiautoteammemb_75319`
...
2. Clone this repo and `cd testapiautoteammemb_75319`
